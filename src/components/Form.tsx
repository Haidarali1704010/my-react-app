...
const FormDetails = () => {
    ...
    const validateAdd= (val:string): void =>{
    ...
    const validateApart = (val:string)=> {
    ...
    const checkAllFlags = () =>{
        if(flag1 && flag2 && flag3 && flag4 && flag5){
            (document.getElementById("btnflag")as any).disabled=false;
            setSubmitAlert("All Information is filled correctly");
        setTimeout(function(){
            (document.getElementById("alerttxt") as any).innerHTML = "";
        }, 3000);
        }
        else{
            (document.getElementById("btnflag")as any).disabled=true;  
